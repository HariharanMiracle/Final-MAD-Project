...
public class HQ4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hq4);
    ...
    public void openIncorrect(){
        Intent intent = new Intent(this, HQ4incor4.class);
        startActivity(intent);
    }
    public void openCorrect1(){
        Intent intent = new Intent(this, HQ4cor4.class);
        startActivity(intent);
    }
}
