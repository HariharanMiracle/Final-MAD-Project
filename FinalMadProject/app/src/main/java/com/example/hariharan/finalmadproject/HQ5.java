...
public class HQ5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hq5);
    ...
    public void openIncorrect(){
        Intent intent = new Intent(this, HQ5incor5.class);
        startActivity(intent);
    }
    public void openCorrect1(){
        Intent intent = new Intent(this, HQ5cor5.class);
        startActivity(intent);
    }
}
