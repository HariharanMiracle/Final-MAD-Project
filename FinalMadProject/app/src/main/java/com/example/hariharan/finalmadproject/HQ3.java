...
public class HQ3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hq3);
    ...
    public void openIncorrect(){
        Intent intent = new Intent(this, HQ3incor3.class);
        startActivity(intent);
    }
    public void openCorrect1(){
        Intent intent = new Intent(this, HQ3cor3.class);
        startActivity(intent);
    }
}
